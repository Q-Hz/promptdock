...
<img src="README_attachment/en/logo.png" alt="PromptDock Logo" width="128"/>

# PromptDock

**A fast, local-first prompt manager and launcher for Windows and macOS.**

[![Version](https://img.shields.io/badge/version-1.4.0-2563eb?style=flat-square)](./package.json)
