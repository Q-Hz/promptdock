...
const zh = {
  ...
  useImportedHint: "使用导入的标题、正文、标签、文件夹、收藏状态、ID、创建时间和使用记录。",
...
const en: Record<keyof typeof zh, string> = {
  ...
  useImportedHint: "Uses the imported title, body, tags, folder, favorite state, ID, creation time, and usage history.",
